    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_no', models.CharField(help_text='Your college issued ID (Optional)', max_length=250, null=True, validators=[django.core.validators.MinLengthValidator(3)], verbose_name='Registration No')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('orders', models.ManyToManyField(blank=True, help_text='This is to be filled by computer', to='payments.Payments')),
