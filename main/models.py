...
class Games(models.Model):
    ...
    short_description = models.TextField(help_text=_('About this short event, better keep it in between 100 characters'), validators=[
                                         MinLengthValidator(13), MaxLengthValidator(200)])
    ...
    platform = models.CharField(max_length=11, choices=(
        ('a', 'ALL'), ('m', 'Mobile'), ('p', 'PC'), ('ps', 'Play Station')), default='A')
...
class GameGroup(models.Model):
    ...
    solo_or_squad = models.CharField(default='sq', choices=(
        ('sq', 'SQUAD'), ('so', 'SOLO')), max_length=15)
    game = models.ForeignKey(Games, on_delete=models.CASCADE)
    users = models.ManyToManyField(settings.AUTH_USER_MODEL)
    payment_id = models.ForeignKey(Payments, on_delete=models.CASCADE, help_text=_(
        'This is to be filled by computer'))
