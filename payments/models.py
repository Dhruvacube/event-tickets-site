...
class Payments(models.Model):
    ...
    request_id_instamojo = models.UUIDField(default=uuid.uuid4,help_text=_('The Request ID by which the INSTAMOJO refers'))
    instamojo_order_id = models.CharField(help_text=_('The order ID by which the INSTAMOJO refers'),null=True,blank=True,max_length=250)
